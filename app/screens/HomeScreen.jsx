...
function HomeScreen ({ navigation }) {
  ...
  useEffect(() => {
    getAllPropertyList()
    // getFilteredPropertyList(categoryName)
    }, [])
  ...
  const getFilteredPropertyList = async (name) => {
    setPropertyList([])
    const q = query(collection(FirebaseDB, "OwnerPosts"), where("propertyType", "==", name));
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Image
                style={{ height: 50, width: 50, borderRadius: 25, marginTop: 12 }}
                source={require('../assets/profile.jpg')}/>
              <TouchableOpacity onPress={() => console.log('notification pressed')}>
                <Image style={{height: 40, width: 40, borderRadius: 25, marginTop: 12, resizeMode: 'contain'}}
            ...
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18}}>
              <TouchableOpacity style={[styles.searchbar, styles.shadow]} onPress={() => console.log(propertyName)}>
            ...
            {/* <ScrollView
              ...
              style={{marginHorizontal: 0, backgroundColor: 'blue' }}
            > */}
