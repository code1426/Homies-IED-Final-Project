...
function Icon({ title }) {
  ...
  else if (title === "3 BedRooms")
    source = require("../../assets/3_Bedrooms.png");
  else if (title === "4 BedRooms")
    source = require("../../assets/4_Bedrooms.png");
  else if (title === "Air Conditioned")
    source = require("../../assets/Air_Conditioned.png");
  else if (title === "Bed Space")
    source = require("../../assets/Bed_Space.png");
  else if (title === "Boys Only")
    source = require("../../assets/Boys_Only.png");
  else if (title === "CCTV Monitored")
    source = require("../../assets/CCTV_Monitored.png");
  else if (title === "Common CR")
    source = require("../../assets/Common_CR.png");
  ...
  else if (title === "Free Water")
    source = require("../../assets/Free_Water.png");
  else if (title === "Free Wi-Fi")
    source = require("../../assets/Piso_Wi-Fi.png");
  else if (title === "Girls Only")
    source = require("../../assets/Girls_Only.png");
  ...
  else if (title === "Near WVSU")
    source = require("../../assets/Near_WVSU.png");
  else if (title === "No Curfew")
    source = require("../../assets/No_Curfew.png");
  else if (title === "Pets Allowed")
    source = require("../../assets/Pets_Allowed.png");
  else if (title === "Piso Wi-Fi")
    source = require("../../assets/Piso_Wi-Fi.png");
...
function FeaturesComponent({ title }) {
  return (
    <View style={featuresStyles.container}>
      {title !== "Dorm" &&
        title !== "Apartment" &&
        title !== "Boarding House" && <Icon title={title} />}

      <Text style={featuresStyles.text}>{title}</Text>
    </View>
  );
}
